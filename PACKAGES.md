...
| --- | --- | --- | --- | --- | --- |
| npm | [@heossihq/bee](https://www.npmjs.com/package/@heossihq/bee) | `1.0.32` | `typescript-sdk` | Apache-2.0 | `npm install @heossihq/bee` |
| PyPI | [bee-sdk](https://pypi.org/project/bee-sdk/) | `1.0.32` | `python-sdk-and-mcp-runtime` | Apache-2.0 | `pip install bee-sdk==1.0.32` |
| MCP Registry | [io.github.heossihq/bee-public](https://registry.modelcontextprotocol.io/v0/servers?search=io.github.heossihq/bee-public) | `1.0.32` | `mcp-server` | Apache-2.0 | `uvx --from "bee-sdk==1.0.32" bee-mcp` |
